...
namespace DataBaseSetupper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string conn = string.Format("Data Source={0};Initial Catalog={1};Integrated Security=True;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False", data_source, initial_catalog);
